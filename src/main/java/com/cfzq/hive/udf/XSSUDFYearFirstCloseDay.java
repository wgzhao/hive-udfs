 ...
 *
 */
@Description(name = "udf_year_first_close_day",
...
public class XSSUDFYearFirstCloseDay extends UDF {
	private final Text result = new Text();

  public Text evaluate(Text s) throws HiveException {
	if (s == null) return null;
	result.set(CloseDateUtil.getFirstCalendarExchangeDay(s.toString(), 3));
	return result;
  }
}
