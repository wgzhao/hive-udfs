 ...
 *
 */
@Description(name = "udf_month_first_close_day",
...
public class XSSUDFMonthFirstCloseDay extends UDF {
	private final Text result = new Text();

  public Text evaluate(Text s) throws HiveException {
	if (s == null) return null;
	result.set(CloseDateUtil.getFirstCalendarExchangeDay(s.toString(), 2));
	return result;
  }
}
