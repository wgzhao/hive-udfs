 ...
 *
 */
@Description(name = "udf_hs_date_diff",
...
public class XSSUDFHsDateDiff extends UDF {
	private final IntWritable result = new IntWritable();

  public IntWritable evaluate(Text s, Text s2) {
	if (s == null) return null;
	result.set((int) CloseDateUtil.hsDateDiff(s.toString(), s2.toString()));
	return result;
  }
}
