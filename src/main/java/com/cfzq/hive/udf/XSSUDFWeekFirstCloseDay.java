 ...
 *
 */
@Description(name = "udf_week_first_close_day",
...
public class XSSUDFWeekFirstCloseDay extends UDF {
	private final Text result = new Text();

  public Text evaluate(Text s) throws HiveException {
	if (s == null) return null;
	result.set(CloseDateUtil.getFirstCalendarExchangeDay(s.toString(), 1));
	return result;
  }
}
